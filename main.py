...
def main():
    ...
    quant_group.add_argument("--quant_calib_samples", type=int, default=16, help="Number of C4 samples to use for calibration.")
...
#     # --- Quantization Error Arguments ---
#     quant_group = parser.add_argument_group('Quantization Error Options (for --eval_quant_error)')
#     quant_group.add_argument("--quant_bits", type=int, default=8, help="Number of bits for quantization (e.g., 8, 4).")
#     quant_group.add_argument(
#         "--quant_granularity", 
#         type=str, 
#         default="per-token", 
#         choices=["per-tensor", "per-token"],
#         help="Granularity for activation quantization."
#     )
#     quant_group.add_argument("--quant_calib_samples", type=int, default=32, help="Number of C4 samples to use for calibration.")
